...
{/*
This file is a duplicate of the CONTRIBUTING.md file at the root level.
...
the [Stewards guide](/contribute/stewards) for details on responsibilities and how to get started.
